    ...
    <>
      ...
      <div class="header center">
        <div class="left_header">
          <a class="logo_for_main" href="index.html">
        ...
        <div class="button_menu">
          ...
          <lable for="burger-checkbox" class="burger">
            <svg
              width="32"
              height="23"
              viewBox="0 0 32 23"
          ...
          <button style={{backgroundColor: "#222222", border: 'none'}} onClick={setClass} class="image_menu link-menu" href="#">
            <svg
              width="32"
              height="23"
              viewBox="0 0 32 23"
          ...
          <a class="image_profile link-menu" href="registration.html">
            <svg
              width="29"
              height="29"
              viewBox="0 0 29 29"
          ...
          <Link class="image_cart link-menu" to="/cart">
            <svg
              width="32"
              height="29"
              viewBox="0 0 32 29"
      ...
      <div className={flag ? "menu open" : "menu close"}>
        <h2 className="menu__heading">Menu</h2>
        <div className="menu__group">
          <h2 className="menu__group_heading">MAN</h2>
          <Link to="/catalog" className="menu__group_category">
            Accessories
          </Link>
          <Link to="/catalog" className="menu__group_category">
            Bags
        ...
        <div className="menu__group">
          <h2 className="menu__group_heading">WOMAN</h2>
          <Link to="/catalog" className="menu__group_category">
            Accessories
          </Link>
          <Link to="/catalog" className="menu__group_category">
        ...
        <div className="menu__group">
          <h2 className="menu__group_heading">KIDS</h2>
          <Link to="catalog" className="menu__group_category">
            Accessories
          </Link>
          <Link to="catalog" className="menu__group_category">
